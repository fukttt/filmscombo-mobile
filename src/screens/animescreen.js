...
class AnimeScreen extends Component {
    constructor (props){
        super(props);
        this.state = {
            data: [],
  ...
  searchFilms (text, search = false, type) {
    var url = "";
    if (search == true){
        url = "https://videocdn.tv/api/animes?api_token=jvbY6usny3y4hgcEvc51TPNunRRsPMms&ordering=created&limit=20&query=" +
        text 
    }else {
        url = "https://videocdn.tv/api/animes?api_token=jvbY6usny3y4hgcEvc51TPNunRRsPMms&ordering=created&limit=20&page=" +
        this.state.page
    }
    return fetch(url)
